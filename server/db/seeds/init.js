...
exports.seed = async (knex) => {
  ...
  await knex('run_events').insert([
    { name: 'andy',date: 'tmrw',event_created_by: user.id, starting_point: 'marcy', ending_point: 'train',description:'fun run', distance: 3.3,max_participants:'14',time:'11',location:'bronx'},
  ])
